...
namespace UnityStandardAssets.ImageEffects
{
    ...
    public class CameraMotionBlur : PostEffectsBase
    {
        ...
        Camera GetTmpCam () {
            ...
            Camera tmpCamCam = tmpCam.GetComponent<Camera>();
            tmpCamCam.CopyFrom(_camera);
            tmpCamCam.enabled = false;
            tmpCamCam.depthTextureMode = DepthTextureMode.None;
            tmpCamCam.clearFlags = CameraClearFlags.Nothing;
