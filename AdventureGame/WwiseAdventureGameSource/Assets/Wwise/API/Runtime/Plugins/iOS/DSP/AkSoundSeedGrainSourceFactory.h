...
#pragma once
/// \file
/// Registers the Soundseed Grain plugin automatically.
...
/// <br><b>Wwise plugin name:</b> Soundseed Grain
/// <br><b>Library file:</b> AkSoundSeedGrainSource.lib

AK_STATIC_LINK_PLUGIN(AkGranularSynth)
